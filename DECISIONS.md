...
- **Railway:** **US East / Virginia** — web runtime + WatchBot worker. Config prepared (`railway.toml` + `railway.worker.toml` + [`docs/DEPLOY.md`](./docs/DEPLOY.md)). Do not create a project or deploy without owner approval.
