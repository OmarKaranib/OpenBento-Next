...
const TOOLS = [
  ...
  { id: "frame", label: "Frame tool", icon: Frame },
...
export function CanvasToolbar() {
  ...
  const { snapshot, undo, redo } = useWorkspace();
  const { frameToolActive, setFrameToolActive, snapToGrid, setSnapToGrid } =
    useWorkspaceUi();
